...
_trampoline2.fnName = 'wasi:cli/stderr@0.2.9#getStderr';
...
_trampoline4.fnName = 'wasi:cli/exit@0.2.9#exit';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline5.fnName = 'wasi:io/streams@0.2.9#blockingWriteAndFlush';
...
const _trampoline6 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:io/error@0.2.9", function="[method]error.to-debug-string"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
...
_trampoline6.fnName = 'wasi:io/error@0.2.9#toDebugString';
...
_trampoline7.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
let exports2;
let postReturn0;
...
function next(arg0, arg1) {
  ...
  _debugLog('[iface="component:session/client-auth@0.1.0", function="next"][Instruction::CallWasm] enter', {
    funcName: 'next',
    paramCount: 5,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => clientAuth010Next(variant1_0, variant1_1, variant1_2, ptr2, len2),
  });
  ...
  _debugLog('[iface="component:session/client-auth@0.1.0", function="next"][Instruction::Return]', {
    funcName: 'next',
    paramCount: 1,
    async: false,
    postReturn: true
...
function finish(arg0) {
  ...
  _debugLog('[iface="component:session/client-auth@0.1.0", function="finish"][Instruction::CallWasm] enter', {
    funcName: 'finish',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'clientAuth010Finish',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => clientAuth010Finish(ptr0, len0),
  });
  ...
  _debugLog('[iface="component:session/client-auth@0.1.0", function="finish"][Instruction::Return]', {
    funcName: 'finish',
    paramCount: 1,
    async: false,
    postReturn: true
...
let clientHandshake010Next;

function next$1(arg0, arg1) {
  var variant1 = arg0;
  let variant1_0;
  let variant1_1;
  let variant1_2;
  ...
  _debugLog('[iface="component:session/client-handshake@0.1.0", function="next"][Instruction::CallWasm] enter', {
    funcName: 'next',
    paramCount: 5,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'clientHandshake010Next',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => clientHandshake010Next(variant1_0, variant1_1, variant1_2, ptr2, len2),
  });
  ...
  _debugLog('[iface="component:session/client-handshake@0.1.0", function="next"][Instruction::Return]', {
    funcName: 'next',
    paramCount: 1,
    async: false,
    postReturn: true
...
let clientHandshake010Finish;

function finish$1(arg0) {
  var val0 = arg0;
  var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
  var ptr0 = realloc0(0, 0, 1, len0 * 1);
  ...
  _debugLog('[iface="component:session/client-handshake@0.1.0", function="finish"][Instruction::CallWasm] enter', {
    funcName: 'finish',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'clientHandshake010Finish',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => clientHandshake010Finish(ptr0, len0),
  });
  ...
  _debugLog('[iface="component:session/client-handshake@0.1.0", function="finish"][Instruction::Return]', {
    funcName: 'finish',
    paramCount: 1,
    async: false,
    postReturn: true
...
function encrypt(arg0, arg1) {
  ...
  _debugLog('[iface="component:session/session@0.1.0", function="encrypt"][Instruction::CallWasm] enter', {
    funcName: 'encrypt',
    paramCount: 4,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => session010Encrypt(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="component:session/session@0.1.0", function="encrypt"][Instruction::Return]', {
    funcName: 'encrypt',
    paramCount: 1,
    async: false,
    postReturn: true
...
let session010Decrypt;

function decrypt(arg0, arg1) {
  var val0 = arg0;
  var len0 = Array.isArray(val0) ? val0.length : val0.byteLength;
  var ptr0 = realloc0(0, 0, 1, len0 * 1);
  ...
  _debugLog('[iface="component:session/session@0.1.0", function="decrypt"][Instruction::CallWasm] enter', {
    funcName: 'decrypt',
    paramCount: 4,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => session010Decrypt(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="component:session/session@0.1.0", function="decrypt"][Instruction::Return]', {
    funcName: 'decrypt',
    paramCount: 1,
    async: false,
    postReturn: true
...
function validate(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="component:session/cookie@0.1.0", function="validate"][Instruction::CallWasm] enter', {
    funcName: 'validate',
    paramCount: 5,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => cookie010Validate(ptr0, len0, ptr1, len1, toUint64(arg2)),
  });
  
  let variant6;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var bool2 = dataView(memory0).getUint8(ret + 8, true);
      let variant4;
      ...
      variant6= {
        tag: 'ok',
        val: {
          authenticated: bool2 == 0 ? false : (bool2 == 1 ? true : throwInvalidBool()),
          did: variant4,
          exp: BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(ret + 24, true))),
        }
      };
      break;
    }
  ...
  _debugLog('[iface="component:session/cookie@0.1.0", function="validate"][Instruction::Return]', {
    funcName: 'validate',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./session.core.wasm', import.meta.url));
    const module1 = base64Compile('AGFzbQEAAAABEQNgBH9/f38AYAJ/fwBgAX8AAwQDAAECBAUBcAEDAwcYBAEwAAABMQABATIAAggkaW1wb3J0cwEACicDDwAgACABIAIgA0EAEQAACwsAIAAgAUEBEQEACwkAIABBAhECAAsALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0MS4y');
    const module2 = base64Compile('AGFzbQEAAAABEQNgBH9/f38AYAJ/fwBgAX8AAh8EAAEwAAAAATEAAQABMgACAAgkaW1wb3J0cwFwAQMDCQkBAEEACwMAAQIALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0MS4y');
    ...
    postReturn0 = exports1['cabi_post_component:session/client-auth@0.1.0#next'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_component:session/client-auth@0.1.0#next']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_component:session/client-auth@0.1.0#next'];
    }
    
    postReturn1 = exports1['cabi_post_component:session/client-auth@0.1.0#finish'];
    
    try {
      postReturn1Async = WebAssembly.promising(exports1['cabi_post_component:session/client-auth@0.1.0#finish']);
    } catch(err) {
      postReturn1Async = exports1['cabi_post_component:session/client-auth@0.1.0#finish'];
    }
    
    postReturn2 = exports1['cabi_post_component:session/cookie@0.1.0#validate'];
    
    try {
      postReturn2Async = WebAssembly.promising(exports1['cabi_post_component:session/cookie@0.1.0#validate']);
    } catch(err) {
      postReturn2Async = exports1['cabi_post_component:session/cookie@0.1.0#validate'];
    }
    
    clientAuth010Next = exports1['component:session/client-auth@0.1.0#next'];
    clientAuth010Finish = exports1['component:session/client-auth@0.1.0#finish'];
    clientHandshake010Next = exports1['component:session/client-handshake@0.1.0#next'];
    clientHandshake010Finish = exports1['component:session/client-handshake@0.1.0#finish'];
    session010Encrypt = exports1['component:session/session@0.1.0#encrypt'];
    session010Decrypt = exports1['component:session/session@0.1.0#decrypt'];
    cookie010Validate = exports1['component:session/cookie@0.1.0#validate'];
  })();
...
export { clientAuth010 as clientAuth, clientHandshake010 as clientHandshake, cookie010 as cookie, session010 as session, clientAuth010 as 'component:session/client-auth@0.1.0', clientHandshake010 as 'component:session/client-handshake@0.1.0', cookie010 as 'component:session/cookie@0.1.0', session010 as 'component:session/session@0.1.0',  }